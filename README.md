...
1. [Reformat code](https://wemake-python-stylegui.de/en/latest/pages/usage/integrations.html#auto-formatters), since we believe that developers should do that
